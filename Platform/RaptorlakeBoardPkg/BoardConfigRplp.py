...
class Board(BaseBoard):
    def __init__(self, *args, **kwargs):
        ...
        self.MICROCODE_INF_FILE   = 'Platform/RaptorlakeBoardPkg/Rplp/Microcode/Microcode.inf'
        ...
        if self.FUSA_SUPPORT:
            ...
            if self.FUSA_BIST_PATTERN_SUPPORT:
                self.FUSA_PATTERN_IS_FFS        = 1
                self.FUSA_STARTUP_BIST_FILE     = 'StartupFuSaPatternFile.bin'

                self._FUSA_PERIODIC_BIST_FILE    = 'saf_e0_b06a2_b06a3_00000002.SIGNED.bin'
